...
Moreover, the adjusted R-squared value is 0.1067, suggesting this
regression model accounts for 11% of the variance.
...
**Comparing our model with the two others**: Based on the RMSE
